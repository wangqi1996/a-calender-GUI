...
public class PIMAppointment extends PIMEntity implements DateTest {
	private Calendar date;
	private String text;
	private Scanner scanner;
	
	public PIMAppointment(Scanner scanner) {
		super(scanner);
	...
	public PIMAppointment(Calendar date, String text,String priority,Scanner scanner,String owner,boolean isPublic) {
	...
	public void fromString() {
		...
		System.out.println("Enter date for todo item: eg 2018/5/28");
		...
		System.out.println("Enter priority: (一个词)");
